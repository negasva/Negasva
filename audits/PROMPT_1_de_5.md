# PROMPT 1 de 5 — Auditorías negasva.shop (items 1–5)
...
### Items de este bloque (Prompt 1/5)
- **Item 1/25** — Autenticación y autorización del panel admin (P0 · Crítico) → `audits/seguridad/autenticacion-admin/prompt.md`
- **Item 2/25** — Row Level Security (RLS) en Supabase (P0 · Crítico) → `audits/seguridad/rls-supabase/prompt.md`
- **Item 3/25** — Validación de inputs y subida de archivos (P0 · Crítico) → `audits/seguridad/validacion-inputs/prompt.md`
- **Item 4/25** — Integridad de precios end-to-end (P0 · Crítico) → `audits/pagos-y-dinero/integridad-precios/prompt.md`
- **Item 5/25** — Webhooks de pago (PayPal / Mercado Pago / legacy) (P0 · Crítico) → `audits/pagos-y-dinero/webhooks/prompt.md`
...
- Dime: "✅ Bloque 1/5 completado (items 1–5). Para continuar, abre un CHAT NUEVO
  y pega el Prompt 2." — y detente ahí. No sigas con items de otros bloques.
