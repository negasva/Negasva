# PROMPT 4 de 5 — Auditorías negasva.shop (items 16–20)
...
### Items de este bloque (Prompt 4/5)
- **Item 16/25** — Experiencia móvil (P1 · Importante) → `audits/conversion/mobile-responsive/prompt.md`
- **Item 17/25** — Ciclo de vida de fotos y datos personales (P1 · Importante) → `audits/datos-y-privacidad/datos-personales-fotos/prompt.md`
- **Item 18/25** — Cumplimiento legal (GDPR / Habeas Data / cookies) (P1 · Importante) → `audits/datos-y-privacidad/cumplimiento-legal/prompt.md`
- **Item 19/25** — Monitoreo, logging y alertas (P1 · Importante) → `audits/confiabilidad/monitoreo-alertas/prompt.md`
- **Item 20/25** — Backups y recuperación ante desastres (P1 · Importante) → `audits/confiabilidad/backups-recuperacion/prompt.md`
...
- Dime: "✅ Bloque 4/5 completado (items 16–20). Para continuar, abre un CHAT NUEVO
  y pega el Prompt 5." — y detente ahí. No sigas con items de otros bloques.
