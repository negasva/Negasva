# PROMPT 3 de 5 — Auditorías negasva.shop (items 11–15)
...
### Items de este bloque (Prompt 3/5)
- **Item 11/25** — Core Web Vitals (Lighthouse) (P1 · Importante) → `audits/rendimiento/core-web-vitals/prompt.md`
- **Item 12/25** — Optimización de imágenes (P1 · Importante) → `audits/rendimiento/imagenes/prompt.md`
- **Item 13/25** — Bundle JS y peso del checkout (P1 · Importante) → `audits/rendimiento/bundle-checkout/prompt.md`
- **Item 14/25** — Fricción en el funnel de checkout (P1 · Importante) → `audits/conversion/friccion-checkout/prompt.md`
- **Item 15/25** — Señales de confianza (P1 · Importante) → `audits/conversion/senales-confianza/prompt.md`
...
- Dime: "✅ Bloque 3/5 completado (items 11–15). Para continuar, abre un CHAT NUEVO
  y pega el Prompt 4." — y detente ahí. No sigas con items de otros bloques.
