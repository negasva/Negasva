...
import { cookiesContent } from '@/lib/i18n/pages/cookies';

export default function CookiesContent() {
  const t = usePageText('cookies', cookiesContent);
        ...
        <div className="mx-auto max-w-3xl space-y-10 text-secondary">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-secondary-lighter">
              <li><strong className="text-secondary">{t.s2_item1_label}</strong> {t.s2_item1_text}</li>
              <li><strong className="text-secondary">{t.s2_item2_label}</strong> {t.s2_item2_text}</li>
              <li><strong className="text-secondary">{t.s2_item3_label}</strong> {t.s2_item3_text}</li>
              <li><strong className="text-secondary">{t.s2_item4_label}</strong> {t.s2_item4_text}</li>
            </ul>
          </div>
