  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-black text-secondary mb-1">Códigos de descuento</h1>
          <p className="text-sm text-secondary-lighter">Gestiona los cupones aplicables al checkout.</p>
        </div>
        <button
          onClick={() => setShowForm(true)}
          className="bg-primary hover:bg-primary-dark text-white font-bold px-5 py-2.5 rounded-xl text-sm transition-colors"
        >
          + Nuevo código
        </button>
      </div>
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="bg-white rounded-xl border border-primary-lighter shadow-sm p-6 mb-6 space-y-4">
