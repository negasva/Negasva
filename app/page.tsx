      ...
      <section className="bg-primary-lighter py-20 px-4">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="caja-mano-1 group relative bg-white p-8 border-2 border-primary-lighter shadow-md hover:shadow-xl hover:border-primary transition-shadow text-center">
