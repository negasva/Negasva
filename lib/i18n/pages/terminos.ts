...
export const terminosContent = {
  es: {
    ...
    s1_title: '1. Aceptación de Términos',
    s1_body:
    ...
    s6_body:
      'NEGASVA no es responsable por daños indirectos o consecuentes. Nuestra responsabilidad máxima está limitada al monto pagado por el pedido en cuestión.',
    s7_title: '7. Cambios a los Términos',
    s7_body:
      'Podemos actualizar estos términos en cualquier momento. Publicaremos los cambios en esta página con la fecha de actualización.',
    s8_title: '8. Contacto',
    s8_body: '¿Preguntas sobre estos términos? Escríbenos a',
  },
  en: {
    badge: 'Legal',
  ...
  fr: {
    ...
    s6_body:
      'NEGASVA n’est pas responsable des dommages indirects ou consécutifs. Notre responsabilité maximale est limitée au montant payé pour la commande concernée.',
    s7_title: '7. Modifications des Conditions',
    s7_body:
      'Nous pouvons mettre à jour ces conditions à tout moment. Nous publierons les modifications sur cette page avec la date de mise à jour.',
    s8_title: '8. Contact',
    s8_body: 'Des questions sur ces conditions ? Écrivez-nous à',
  },
